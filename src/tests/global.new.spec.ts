...
describe('Manage global', () => {
  ...
  it('should query all with mixed (assets, entries, taxonomies and templates)', async () => {
    createAsset([basicCreateAssetPayload]);
    createEntry([basicCreateEntryPayload]);
    createTaxonomy([basicCreateTaxonomyPayload]);
    createTemplate([basicCreateTemplatePayload]);
  ...
  it('should process all with only assets', async () => {
    createAsset([basicCreateAssetPayload]);

    const all = await processAll({ cluster: 'devnet', payer: payer });
  ...
  it('should process all with only entries', async () => {
    createEntry([basicCreateEntryPayload]);
  ...
  it('should process all with only taxonomies', async () => {
    createTaxonomy([basicCreateTaxonomyPayload]);
  ...
  it('should process all with only templates', async () => {
    createTemplate([basicCreateTemplatePayload]);
  ...
  it('should process all with mixed (assets, entries, taxonomies and templates)', async () => {
    createAsset([basicCreateAssetPayload]);
    createEntry([basicCreateEntryPayload]);
    createTaxonomy([basicCreateTaxonomyPayload]);
    createTemplate([basicCreateTemplatePayload]);
